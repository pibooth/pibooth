...
EVT_PIBOOTH_BTN_CAPTURE = pygame.USEREVENT + 201        # buttons, leds
EVT_PIBOOTH_BTN_PRINT = pygame.USEREVENT + 202          # buttons, leds
EVT_PIBOOTH_BTN_SETTINGS = pygame.USEREVENT + 203       # buttons, leds
