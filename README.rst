...
.. |Tests| image:: https://github.com/pibooth/pibooth/actions/workflows/ci.yml/badge.svg?branch=3.x
   :target: https://github.com/pibooth/pibooth/actions/workflows/ci.yml?query=branch%3A3.x
   :alt: Tests
