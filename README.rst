...
.. |Tests| image:: https://github.com/pibooth/pibooth/actions/workflows/ci.yml/badge.svg?branch=master
   :target: https://github.com/pibooth/pibooth/actions/workflows/ci.yml?query=branch%3Amaster
   :alt: Tests
